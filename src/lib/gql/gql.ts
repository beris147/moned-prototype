...
const documents: Documents = {
    ...
    "\n  query FollowedProviders($userId: UUID!) {\n    user_provider_followCollection(filter: { user_id: { eq: $userId } }) {\n      edges {\n        node {\n          provider {\n            id\n            user {\n              full_name\n            }\n          }\n        }\n      }\n    }\n  }\n": types.FollowedProvidersDocument,
