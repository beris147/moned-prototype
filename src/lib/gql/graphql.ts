...
export type ChatMessagesQuery = { __typename: 'Query', chatCollection?: { __typename: 'chatConnection', edges: Array<{ __typename: 'chatEdge', node: { __typename: 'chat', id: string, user1?: { __typename: 'user', id: string, full_name?: string | null } | null, user2?: { __typename: 'user', id: string, full_name?: string | null } | null, messageCollection?: { __typename: 'messageConnection', edges: Array<{ __typename: 'messageEdge', node: (
              { __typename: 'message' }
...
export type MessageFragment = { __typename: 'message', id: string, content: string, created_at: string, from_user?: { __typename: 'user', id: string, full_name?: string | null } | null, to_user?: { __typename: 'user', id: string, full_name?: string | null } | null } & { ' $fragmentName'?: 'MessageFragment' };
